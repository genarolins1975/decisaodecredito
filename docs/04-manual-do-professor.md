...
2. Escolha a página e "Mostrar aos alunos", ou "Projetar em tela cheia": a apresentação avisa os alunos a cada página que você avança (N mostra as notas privadas, F tela cheia, Esc sai).
   ...
   Em Aulas, a Aula 2 tem a mesma moldura das outras aulas: uma abertura como a de um capítulo (`/aulas/aula-2`, com a pergunta central, o que se aprende, os 50 slides por bloco, o que a aula assume, o material para levar e as aulas vizinhas) e uma página por slide (`/aulas/aula-2/slide/NN`), com a lista dos slides na lateral, o baralho embutido, o resumo do slide, os links do apêndice e Anterior e Próxima. Para você e para o monitor, a página do slide traz também o roteiro dele (condução, mensagem que fecha, transição, respostas esperadas, cuidados e aprofundar). "Ver em tela cheia" abre o baralho sozinho, e a barra dele ganha o link "Aulas", que volta à página do slide em que você estava.
