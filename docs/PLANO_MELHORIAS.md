...
| R8 | Servir os dois guias pela plataforma: rota autenticada por papel (como `/slides/aula-2`) e cadastro em Materiais, o do aluno para a turma e o do professor só para a equipe | hoje os PDFs ficam em `content/materiais/` e são distribuídos fora da plataforma | M17 | aluno baixa só o guia do aluno; professor e monitor baixam os dois; 403 fora da turma | pequeno |
