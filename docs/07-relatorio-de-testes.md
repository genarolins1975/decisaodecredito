...
|---|---|---|
| Unidade, reconciliação numérica, TLS, feedback em dois estágios e prerrequisitos, identidade Gmail, importação de listas, visuais nativos contra o gerador (regras temporais, motor econômico, regressão logística, árvore e boosting) e compositor do deck (79 testes) | `npm test` | 79 passaram em 18/09/2026 |
