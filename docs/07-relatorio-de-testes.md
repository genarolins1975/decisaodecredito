...
|---|---|---|
| Unidade, reconciliação numérica, TLS, feedback em dois estágios e prerrequisitos, identidade Gmail, importação de listas, visuais nativos contra o gerador (regras temporais, motor econômico, regressão logística e árvore) e compositor do deck (76 testes) | `npm test` | 76 passaram em 18/09/2026 |
