...
|---|---|---|
| Unidade, reconciliação numérica, TLS, feedback em dois estágios e prerrequisitos, identidade Gmail, importação de listas e visuais nativos contra o gerador e as regras temporais (54 testes) | `npm test` | 54 passaram em 18/09/2026 |
