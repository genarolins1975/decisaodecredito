...
|---|---|---|
| Unidade, reconciliação numérica, TLS, feedback em dois estágios e prerrequisitos, identidade Gmail, importação de listas e visuais nativos contra o gerador (51 testes) | `npm test` | 51 passaram em 18/09/2026 |
